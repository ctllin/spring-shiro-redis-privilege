 ...
 -->	<div data-options="region:'center',border:false" title="" style="overflow: auto;padding: 3px;">
		<table class="grid">
		    <tr>
				...
				<td><div>${beanData.goodsId}</div></td>
			</tr>
			<tr>
				<td >SKUID</td>
				<td>${beanData.skuId}</td>
			</tr>
			<tr>
				<td >仓库编号</td>
				<td>${beanData.warehouseId}</td>
			</tr>
			<tr>
				<td >分类</td>
				<td>${beanData.category}</td>
			</tr>
			<tr>
				<td >品牌国</td>
				<td>${beanData.brandCountryName}</td>
			</tr>
			<tr>
				<td >库房名称</td>
				<td>${beanData.warehouseName}</td>
			</tr>
			<tr>
				<td >商品税率</td>
				<td>${beanData.taxRate}</td>
			</tr>
			
			<tr>
				<td>商品图片</td>
				<td><img src='${beanData.imageUrl}' /></td>
			</tr>
			<tr>
				<td>商品详情</td>
				<td><div>${beanData.detailStr}</div></td>
			</tr>
			<%-- 
			<tr>
