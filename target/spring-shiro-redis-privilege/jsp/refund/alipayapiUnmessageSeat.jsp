 ...
 */
%>
<%@ page import="com.alipayunmessage.config.*"%>
<%@ page import="com.alipayunmessage.util.*"%>
...
<html>
	...
	<%
		...
		sParaTemp.put("service", AlipayConfigRefund.service);
        sParaTemp.put("partner", AlipayConfigRefund.partner);
        sParaTemp.put("_input_charset", AlipayConfigRefund.input_charset);
		sParaTemp.put("notify_url", AlipayConfigRefund.notify_url_seat);
		sParaTemp.put("seller_user_id", "2088521539908280");
	    sParaTemp.put("refund_date",AlipayConfigRefund.refund_date );
