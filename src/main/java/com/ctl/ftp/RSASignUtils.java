...
public class RSASignUtils {
    ...
    public static String  getSignMsg(String orderNumber,String type){
    	return genSignByRSA(new StringBuilder("version=2.6&serialID=").append(orderNumber).append("&mode=1&type=").append(type).append("&orderID=").append(orderNumber).append("&beginTime=&endTime=&partnerID=11000000473&remark=1&charset=1&signType=1").toString());
    }
	...
	public static void main(String[] args) {
		   ...
		   str=getSignMsg("DK201612161707549717600CB6D1CF23","1");
		   System.out.println(str);
	}
    /**
     * 使用该方法，对需要进行rsa签名的字符串进行签名操作
     *
     * @param rsaMsg 需要签名的字符串
     * @return
     */
