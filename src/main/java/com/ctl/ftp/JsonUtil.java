...
public final class JsonUtil
{
	...
	public static void main(String[] args) {
		...
		list.add(new Tat(UUID.randomUUID().toString()));
		list.add(new Tat(UUID.randomUUID().toString()));
		pp.setListTat(list);
		System.out.println(object2Json(pp));
	}
...
class Person{
	...
	public List<Tat> getListTat() {
		return listTat;
	}
	public void setListTat(List<Tat> listTat) {
		this.listTat = listTat;
	}
}
class Tat{
	public Tat(){};
	public Tat(String uuid){
		this.uuid=uuid;
	}
	private String uuid;
