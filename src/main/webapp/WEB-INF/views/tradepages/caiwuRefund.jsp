...
<form id="refundForm" method="post">
	 <table>
	    <tr>
			<td style="width: 10%">订单号</td><td><input name="orderNumber2" id="orderNumber2" class="easyui-textbox" style="width:250px" data-options="required:true">
			</td>
			<td style="width: 10%">退款金额(分)</td><td><input class="easyui-numberbox" id="refundMoney" name="refundMoney" style="width:90px;text-align:right;" max="99999999"  data-options="required:true">
			</td>
