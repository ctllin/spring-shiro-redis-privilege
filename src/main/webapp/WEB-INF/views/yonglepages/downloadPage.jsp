...
<script type="text/javascript">
	$(function() {
		...
		$('#downloadForm').form({
			url : '${ctx}/yongle/productInfoYl/download',//
			onSubmit : function() {
				progressLoad();
		...
		<form id="downloadForm" method="post">
			...
			<%-- 	<tr>
				...
				<tr>
					...
					<td colspan="3"><textarea  name="productIds" id="productIds" rows="15" cols="60" placeholder="请输入票品编号多个之间用英文,隔开" class="easyui-validatebox" data-options="required:true" ></textarea></td>
