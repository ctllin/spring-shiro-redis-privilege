		...
		layout_west_tree = $('#layout_west_tree').tree({
			...
			onClick : function(node) {
				if (node.attributes && node.attributes.url) {
					...
					if(url.indexOf('http')>0){//如果配置的不是本地路径则直接显示页面
...
<body>
	...
	<div id="index_layout">
		...
		<div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >版权所有@北京喜乐航科技股份有限公司 </div>
	</div>
