	...
	<form id="resourceAddForm" method="post">
		<table class="grid">
			...
			<tr>
				<td>菜单图标</td>
				<td ><!-- <input  name="icon" /> -->
				<select name="icon" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
			...
			<tr>
				<td>描述</td>
				<td><input name="description" type="text" placeholder="请输入描述" class="easyui-validatebox span2" data-options="width:140,height:29" ></td>
			</tr>
		</table>
	</form>
</div>