	...
	<form id="organizationEditForm" method="post">
		<table class="grid">
			...
			<tr>
				...
				<td>菜单图标</td>
				<td><%-- <input  name="icon" value="${organization.icon}"/> --%>
					<select id="icon" name="icon" value="${organization.icon}"  class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
