	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
		<form id="userAddForm" method="post">
			<table class="grid">
				...
				<tr>
				   <td>航渠</td>
					<td><select name="airCompany" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							<option value="">&nbsp;</option>
				...
				<tr>
					<td>供应商编号</td>
					<td colspan="3">
						<input type="text" name="supplier_id" class="easyui-numberbox"/>
					</td>
				</tr>
			</table>
		</form>
