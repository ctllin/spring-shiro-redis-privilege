<%@page import="com.ctl.sys.manger.utils.ConfigUtils"%>
...
<%@ page import="com.alipaywithmessage.config.*"%>
<%@ page import="com.alipaywithmessage.util.*"%>
...
<html>
	...
	<%
		...
		sParaTemp.put("service", AlipayConfigRefundRSA.service);
        sParaTemp.put("partner", AlipayConfigRefundRSA.partner);
        sParaTemp.put("_input_charset", AlipayConfigRefundRSA.input_charset);
		sParaTemp.put("notify_url", ConfigUtils.getType("alipay.withmessage.refund_notify_url.seat"));
		sParaTemp.put("seller_user_id", "2088511721955154");
		sParaTemp.put("refund_date", AlipayConfigRefundRSA.refund_date);
		sParaTemp.put("batch_no", batch_no);
		sParaTemp.put("batch_num", batch_num);
		sParaTemp.put("detail_data", detail_data);
		
		//建立请求
		String sHtmlText = AlipaySubmitRSA.buildRequest(sParaTemp,"get","确认");
